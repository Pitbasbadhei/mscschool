...
const demoData = [
  { id: 1, GroupCode: 'GRP001', GroupName: 'Administrator' },
  { id: 2, GroupCode: 'GRP002', GroupName: 'Editor' },
  { id: 3, GroupCode: 'GRP003', GroupName: 'Viewer' },
  { id: 4, GroupCode: 'GRP004', GroupName: 'Moderator' },
  { id: 5, GroupCode: 'GRP005', GroupName: 'Guest' },
  { id: 6, GroupCode: 'GRP006', GroupName: 'Manager' },
  { id: 7, GroupCode: 'GRP007', GroupName: 'Analyst' },
];

const SecurityRightsView = () => {
  ...
  const addGroup = (newGroup) => {
    setRecords((prevRecords) => [...prevRecords, newGroup]);
  };
  ...
  const handleEdit = (id) => {
    ...
    navigate(`/master/securityrights/edit/${id}`);
  };
  ...
  const handleAdd = () => {
    navigate('/Setup/SecurityRight/add');
  };
  ...
  return (
    <div className="max-w-8xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800">Security Rights</h2>
        ...
        <table className="min-w-full table-auto">
          <thead>
            <tr className="bg-gray-100">
              <th className="px-4 py-2 text-left text-sm font-medium text-gray-700">Group Code</th>
              <th className="px-4 py-2 text-left text-sm font-medium text-gray-700">Group Name</th>
          ...
          <tbody>
            {currentItems.map((item) => (
              <tr key={item.id} className="hover:bg-gray-50">
                <td className="px-4 py-2 text-gray-800">{item.GroupCode}</td>
                <td className="px-4 py-2 text-gray-800">{item.GroupName}</td>
...
export default SecurityRightsView;